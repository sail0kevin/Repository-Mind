...
def get_settings(secret_store: SecretStore = Depends(get_secret_store)) -> SettingsResponse:
    ...
    return SettingsResponse(
        ...
        reranker_provider=current.get("reranker_provider", defaults.reranker_provider),
        reranker_model=current.get("reranker_model", defaults.reranker_model),
        reranker_use_fp16=current.get("reranker_use_fp16", defaults.reranker_use_fp16),
        reranker_candidate_limit=current.get("reranker_candidate_limit", defaults.reranker_candidate_limit),
